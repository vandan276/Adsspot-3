...
// 1. Signature 4-Node Brand Logo Mark (From adsspot.svg)
export const AdsspotLogoMark: React.FC<{ size?: number; className?: string }> = ({
  size = 36,
  className = '',
}) => {
  return (
...
// 2. Complete Brand Logo Component (Icon + Seamless ADSSPOT Typography, No Line)
export const Logo: React.FC<LogoProps> = ({
  ...
  if (!withText) {
    return <AdsspotLogoMark size={pixelHeight} className={className} />;
  }

  // Calculate proportional width based on viewBox 280 x 70
  const pixelWidth = Math.round((pixelHeight / 70) * 280);
  ...
  return (
    <div className={`inline-flex items-center shrink-0 ${className}`}>
      ...
      >
        {/* 1. Left Logo Mark (110x110 scaled to 58x58) */}
        <g transform="translate(0, 6) scale(0.53)">
          <g id="Layer-1">
            <g>
              ...
              <path d="M28.1604 72.5079C28.1604 67.2434 32.4282 62.9756 37.6927 62.9756C42.9573 62.9756 47.225 67.2434 47.225 72.5079C47.225 77.7725 42.9573 82.0402 37.6927 82.0402C32.4282 82.0402 28.1604 77.7725 28.1604 72.5079Z" fill="none" stroke="#981837" strokeWidth="7" strokeLinecap="butt" strokeLinejoin="round"/>
            </g>
            <g>
              ...
              <path d="M81.8396 37.4921C81.8396 42.7566 77.5718 47.0244 72.3073 47.0244C67.0427 47.0244 62.775 42.7566 62.775 37.4921C62.775 32.2275 67.0427 27.9598 72.3073 27.9598C77.5718 27.9598 81.8396 32.2275 81.8396 37.4921Z" fill="none" stroke="#35ab4e" strokeWidth="7" strokeLinecap="butt" strokeLinejoin="round"/>
            </g>
            <g>
              ...
              <path d="M81.8396 72.5079C81.8396 67.2434 77.5718 62.9756 72.3073 62.9756C67.0427 62.9756 62.775 67.2434 62.775 72.5079C62.775 77.7725 67.0427 82.0402 72.3073 82.0402C77.5718 82.0402 81.8396 77.7725 81.8396 72.5079Z" fill="none" stroke="#4787f2" strokeWidth="7" strokeLinecap="butt" strokeLinejoin="round"/>
            </g>
            <g>
              ...
              <path d="M28.1604 37.4921C28.1604 42.7566 32.4282 47.0244 37.6927 47.0244C42.9573 47.0244 47.225 42.7566 47.225 37.4921C47.225 32.2275 42.9573 27.9598 37.6927 27.9598C32.4282 27.9598 28.1604 32.2275 28.1604 37.4921Z" fill="none" stroke="#f2b604" strokeWidth="7" strokeLinecap="butt" strokeLinejoin="round"/>
            </g>
        ...
        {/* 2. Seamless ADSSPOT Brand Name (No space between ADS and SPOT, No Underline) */}
        <g transform="translate(72, 51)">
          <text
            fontFamily="'DIN Condensed', 'DIN Alternate', 'Impact', 'Plus Jakarta Sans', sans-serif"
            fontSize="54"
            fontWeight="900"
            letterSpacing="0"
          >
