...
export const SEED_BUSINESSES: Business[] = [
  ...
  },
  {
    ...
    owner_id: 'usr-merch-prem',
    category_id: 'cat-doc',
    name: 'Dr. Thakor Skin & Laser Clinic',
    slug: 'dr-thakor-skin-clinic',
    description: 'Premier clinical dermatology, laser aesthetics, PRP hair treatments and acne skincare solutions in Alkapuri.',
    address: 'Opp. Centre Square Mall, Alkapuri',
    pincode: '390007',
    lat: 22.3142,
    lng: 73.1654,
    phone: '+912652345678',
    ...
    cover_url: 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=800&auto=format&fit=crop&q=80',
    trusted: true,
    status: 'active',
    tier: 'premium',
    created_at: '2026-02-05T00:00:00Z',
    stats: { views_count: 8400, likes_count: 1420, followers_count: 920, reviews_count: 88, avg_rating: 4.85 },
  },
  {
    id: 'biz-travel-1',
    owner_id: 'usr-merch-prem',
    category_id: 'cat-travel',
    name: 'Akshar Travels & Holiday Hub',
    slug: 'akshar-travels-vadodara',
    description: 'Custom domestic and international flight bookings, visa stamping, and Kashmir & Dubai holiday packages.',
    ...
    cover_url: 'https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=800&auto=format&fit=crop&q=80',
    trusted: true,
    status: 'active',
    tier: 'premium',
    created_at: '2026-02-06T00:00:00Z',
    stats: { views_count: 12200, likes_count: 2100, followers_count: 1400, reviews_count: 112, avg_rating: 4.75 },
  },
  {
    id: 'biz-beauty-1',
    owner_id: 'usr-merch-elite',
    category_id: 'cat-beauty',
    name: 'Enrich Luxury Salon & Spa',
    slug: 'enrich-salon-alkapuri',
    description: 'Luxury hair styling, bridal makeup, Keratin hair botox, and organic facial spa treatments by top artists.',
    address: 'Windsor Plaza, RC Dutt Road, Alkapuri',
    pincode: '390007',
    lat: 22.3115,
    lng: 73.1685,
    phone: '+912652311222',
    ...
    cover_url: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=800&auto=format&fit=crop&q=80',
    trusted: true,
    status: 'active',
    tier: 'elite',
    created_at: '2026-02-08T00:00:00Z',
    stats: { views_count: 21400, likes_count: 4200, followers_count: 3100, reviews_count: 195, avg_rating: 4.9 },
  },
  {
    id: 'biz-gym-1',
    owner_id: 'usr-merch-prem',
    category_id: 'cat-gym',
    name: 'Gold Coast Fitness & CrossFit',
    slug: 'gold-coast-fitness',
    description: 'Certified 1-on-1 personal trainers, imported Hammer Strength machines, steam room & functional training zone.',
    address: 'Near Akota Stadium, Akota',
    pincode: '390020',
    lat: 22.2985,
    lng: 73.1745,
    phone: '+912652355555',
    ...
    cover_url: 'https://images.unsplash.com/photo-1517838277536-f5f99be501cd?w=800&auto=format&fit=crop&q=80',
    trusted: true,
    status: 'active',
    tier: 'premium',
    created_at: '2026-02-10T00:00:00Z',
    stats: { views_count: 16800, likes_count: 3100, followers_count: 1980, reviews_count: 164, avg_rating: 4.8 },
  },
  {
    id: 'biz-repairs-1',
    owner_id: 'usr-merch-basic',
    category_id: 'cat-repairs',
    name: 'Cool Breeze AC & Appliance Care',
    slug: 'cool-breeze-ac-service',
    description: '24/7 doorstep AC repair, gas filling, refrigerator service & washing machine motherboard diagnostics with 90-day warranty.',
    ...
    cover_url: 'https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=800&auto=format&fit=crop&q=80',
    trusted: true,
    status: 'active',
    tier: 'basic',
    created_at: '2026-02-12T00:00:00Z',
    stats: { views_count: 7600, likes_count: 1100, followers_count: 650, reviews_count: 78, avg_rating: 4.65 },
  },
  {
    id: 'biz-realestate-1',
    owner_id: 'usr-merch-elite',
    category_id: 'cat-realestate',
    name: 'Prime Square Realty & Developers',
    slug: 'prime-square-realty',
    description: 'RERA-registered luxury 3/4 BHK penthouses, high street commercial showrooms & verified industrial plots in GIDC.',
    address: 'Monisha Complex, Old Padra Road',
    pincode: '390020',
    lat: 22.2928,
    lng: 73.1610,
    phone: '+912652377777',
    ...
    cover_url: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&auto=format&fit=crop&q=80',
    trusted: true,
    status: 'active',
    tier: 'elite',
    created_at: '2026-02-14T00:00:00Z',
    stats: { views_count: 24500, likes_count: 4800, followers_count: 3600, reviews_count: 210, avg_rating: 4.92 },
  },
  {
    id: 'biz-edu-1',
    owner_id: 'usr-merch-prem',
    category_id: 'cat-edu',
    name: 'Zenith Academy for NEET & JEE',
    slug: 'zenith-academy-vadodara',
    description: 'Expert faculty from IITs & AIIMS, digital smart classrooms, personal doubt sessions & comprehensive test series.',
    address: 'Near Inox Multiplex, Race Course',
    pincode: '390007',
    lat: 22.3180,
    lng: 73.1730,
    phone: '+912652388888',
    ...
    cover_url: 'https://images.unsplash.com/photo-1509062522246-3755977927d7?w=800&auto=format&fit=crop&q=80',
    trusted: true,
    status: 'active',
    tier: 'premium',
    created_at: '2026-02-16T00:00:00Z',
    stats: { views_count: 18900, likes_count: 3400, followers_count: 2600, reviews_count: 180, avg_rating: 4.88 },
  },
  // Mumbai Businesses
  {
    id: 'biz-elite-1',
